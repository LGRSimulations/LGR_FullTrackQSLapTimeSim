...
def runLapTimeSimulation(track, vehicle, config) -> None:
    ...
    results = LapTimeResults(
        track=track,
        finalSpeeds=np.array(finalSpeeds),
        cornerSpeeds=np.array(cornerSpeeds),
        lapTime=lapTime,
        gLatChannel=gLatChannel,
        gLongChannel=gLongChannel,
        muLongChannel=muLongChannel,
        muLatChannel=muLatChannel,
        muCombinedChannel=muCombinedChannel,
        signedMuLongChannel=signedMuLongChannel,
        signedMuLatChannel=signedMuLatChannel,
        normalLoadPerTyre=normalLoadPerTyre,
        longForcePerTyre=longForcePerTyre,
        latForcePerTyre=latForcePerTyre,
